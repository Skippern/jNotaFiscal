...
public class TravelExpenseBoatElement {
	private TravelExpenseBoatElement nextElement;
	private TravelExpenseBoatElement previousElement;
	...
	TravelExpenseBoatElement(String from, String to, double price) {
		elementFrom = from;
		elementTo = to;
		elementPrice = price;
	}
	TravelExpenseBoatElement(String from, String to, Date date, double price) {
		elementFrom = from;
		elementTo = to;
		travelDate = date;
		elementPrice = price;
	}
	TravelExpenseBoatElement(String from, String to, double price, CurrencyElement currency) {
		elementFrom = from;
		elementTo = to;
		elementPrice = price;
		elementCurrency = currency;
	}
	TravelExpenseBoatElement(String from, String to, Date date, double price, CurrencyElement currency) {
		elementFrom = from;
		elementTo = to;
		travelDate = date;
		elementPrice = price;
	...
	public TravelExpenseBoatElement getNext() {
		return nextElement;
	}
	public TravelExpenseBoatElement getPrevious() {
		return previousElement;
	}
	public void setNext(TravelExpenseBoatElement next) {
		nextElement = next;
	}
	public void setPrevious(TravelExpenseBoatElement previous) {
